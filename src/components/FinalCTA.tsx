      ...
      <div className="relative mx-auto max-w-[850px] px-6 lg:px-10">
        <div className="text-center">
          ...
          <Reveal delay={0.12}>
            <p className="mx-auto mt-4 max-w-[500px] font-body text-[0.95rem] leading-relaxed text-paper/65">
              One call with a senior strategist — not a salesperson. Select a convenient slot on our calendar below, or drop us a line directly.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal delay={0.18}>
          <div className="mt-10 flex justify-center">
            <div className="flex gap-1.5 rounded-full bg-paper/5 p-1 border border-paper/10">
              <button
                onClick={() => {
                  setActiveTab("calendly");
                  setIframeLoading(true);
                }}
                className={`focus-ring rounded-full px-5 py-2 text-[0.88rem] font-semibold cursor-pointer transition-all duration-300 ${
                  activeTab === "calendly"
                    ? "bg-green text-paper"
        ...
        <Reveal delay={0.24}>
          <div className="mt-10 min-h-[500px] rounded-2xl border border-paper/10 bg-dark-soft/40 p-1.5 backdrop-blur-md">
            {activeTab === "calendly" ? (
              <div className="relative h-[650px] w-full overflow-hidden rounded-xl bg-white">
                {iframeLoading && (
                ...
                <iframe
                  src="https://calendly.com/thegrowthinc/30min?embed_domain=localhost&embed_type=inline&hide_landing_page_details=1&hide_gdpr_banner=1"
                  width="100%"
                  height="100%"
